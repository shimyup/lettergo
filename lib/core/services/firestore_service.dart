...
class FirestoreService {
  ...
  static Future<List<Map<String, dynamic>>> queryCollection(
    ...
    try {
      var url = '${FirebaseConfig.firestoreBase}/$collectionPath?pageSize=$limit';
  ...
  static dynamic _toFirestoreValue(dynamic value) {
    ...
    if (value is Map) return {'mapValue': {'fields': _toFirestoreFields(value.cast<String, dynamic>())}};
  ...
  static dynamic _fromFirestoreValue(Map<String, dynamic> value) {
    ...
    if (value.containsKey('arrayValue')) {
      ...
      return values.map((e) => _fromFirestoreValue(e as Map<String, dynamic>)).toList();
    }
